...
* The main textbook for this course is the monograph in the root folder. Click here for [the mongraph](https://github.com/mkchenxi/Causal-Inference/blob/main/FnT_Marketing_Assumptions_in_Causal_Inference.pdf).  
