...
- [Estimating the ATT](#estimating-the-att)
- [Examining the parallel trend
  assumption](#examining-the-parallel-trend-assumption)
  - [Placebo tests with
    pseudo-treatments](#placebo-tests-with-pseudo-treatments)
  - [Event study plots](#event-study-plots)
...
# Examining the parallel trend assumption
...
![](Tutorial-4-DID_files/figure-gfm/chunk-5-1.png)<!-- -->
...
![](Tutorial-4-DID_files/figure-gfm/chunk-6-1.png)<!-- -->
